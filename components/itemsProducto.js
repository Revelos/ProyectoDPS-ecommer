        ...
        <View style={styles.item}>
          ...
          <View style={styles.itemContainer2}>
            <View style={styles.itemContainer3}>
              <View style={styles.itemContainer4}></View>
            </View>
          </View>
        </View>
        <Text style={{ fontSize: 24, fontWeight: '700', marginTop: 60, textAlign: 'center' }}>Camisa #1</Text>
        <Text style={{ fontSize: 20, fontWeight: '400', marginLeft: 15, textAlign: 'center' }}>
          Hermosa camisa con estampado Red Devils{' '}
        </Text>
        <TouchableOpacity
          style={styles.boton}
          onPress={() => {
            navigation.navigate('FormCompra');
          }}
        >
